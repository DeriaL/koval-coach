...
export function FloatingContact() {
  ...
  return (
    <div
      className={`fixed right-4 md:right-6 z-40 flex flex-col items-end transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10 pointer-events-none"}`}
